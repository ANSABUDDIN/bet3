...
import ChartOne from '../Chart/Elements/ChartOne'
import ChartTwo from '../Chart/Elements/ChartTwo'
import MatchRow from '../Chart/Elements/MatchRow'
import Progressbar from '../Chart/Elements/Progressbar'
        ...
        <>
            ...
            <div className="container-fluid">
                <div className="d-flex">
                    ...
                    <Sidebar />
                    <div className='row w-90 mx-0 w-100 align-items-stretch ' >
                        <div className="col-lg-9 px-0  col-md-12 col-sm-12 col-12 scroll-div ">
                            <div className='row mx-0 '>
                                <div className="d-flex align-items-center ">
                                    ...
                                    <div>
                                        <p className="fw-600 text-uppercase fs-4 mb-0 text-white">Jacksonville Jaguars
                                        </p>
                                ...
                                <div className="row  mt-2 mx-0">
                                    ...
                                    <div className=" mb-3 mt-lg-0 mt-3 col-lg-3 col-12 ">
                                        <div className={mood == 0 ? "cla mini-none Matchup__box scroll-seprate3" : "cla  Matchup__box scroll-seprate3"}>
                                    ...
                                    <div className="col-lg-9">
                                        <div className="d-flex flex-wrap gap-lg-0 gap-2 justify-content-center">
                                            <div className="d-flex cart__card my-3 align-items-center justify-content-between w-100  text-light">
                                        ...
                                        <div className='d-flex justify-content-between align-items-center' >
                                            <div>
                                                <label className=' mt-lg-4 pointer text-muted fw-600 fs-7 d-flex align-items-center gap-2' >
                                                    <input type="checkbox" id="cheakboxnew" />
                                                    Show  Last Season
                                                </label>
                                            </div>
                                        ...
                                        <div className='d-flex   mt-3 flex-lg-row flex-column  gap-3 '>
                                            <div className="w-100">
                                                <div className='d-flex justify-content-between align-items-center'>
                                                    <div className=' mt-lg-4'>
                                                        <p className='fs-5 tex_shadow mb-0 fw-600 text-light'>
                                                            JAX  Off. Rank
                                                        </p>
                                                        <div>
                                                            <p className="text-muted fw-600">
                                                    ...
                                                    <div className='d-flex'>
                                                        <div className='text-white pointer cart__card px-3 py-1'>
                                                            10
                                                        </div>
                                                    </div>
                                                </div>
